...
public final class intention_set_Atribut_type_string_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  private Collection<IntentionExecutable> myCachedExecutable;

  public intention_set_Atribut_type_string_Intention() {
    super(Kind.ERROR, false, new SNodePointer("r:90274395-b22a-4026-877b-f66a97996602(ClassDiagramDSLMilosProrocic.intentions)", "2465447832826542597"));
  }

  @Override
  public String getPresentation() {
    return "intention_set_Atribut_type_string";
  }
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public String getDescription(final SNode node, final EditorContext editorContext) {
      return "Postavi tip string";
    }

    @Override
    public void execute(final SNode node, final EditorContext editorContext) {
      SPropertyOperations.assign(node, PROPS.tipAtributa$Len0, "string");
    }
    ...
    private boolean isApplicableToNode(final SNode node, final EditorContext editorContext) {
      ...
      return SPropertyOperations.getString(node, PROPS.tipAtributa$Len0) == null || ("string".contains(SPropertyOperations.getString(node, PROPS.tipAtributa$Len0)) && !(SPropertyOperations.getString(node, PROPS.tipAtributa$Len0).equals("string")));
    }


    @Override
    public IntentionDescriptor getDescriptor() {
      return intention_set_Atribut_type_string_Intention.this;
    }
