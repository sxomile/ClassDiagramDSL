...
public final class intention_set_Atribut_type_undefined_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  ...
  public intention_set_Atribut_type_undefined_Intention() {
    super(Kind.ERROR, false, new SNodePointer("r:90274395-b22a-4026-877b-f66a97996602(ClassDiagramDSLMilosProrocic.intentions)", "1517646760598733250"));
  }

  @Override
  public String getPresentation() {
    return "intention_set_Atribut_type_undefined";
  }
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public String getDescription(final SNode node, final EditorContext editorContext) {
      return "Postavi tip undefined";
    }

    @Override
    public void execute(final SNode node, final EditorContext editorContext) {
      SPropertyOperations.assign(node, PROPS.tipAtributa$Len0, "undefined");
    }
    ...
    public IntentionDescriptor getDescriptor() {
      return intention_set_Atribut_type_undefined_Intention.this;
    }
