...
public final class intention_set_Atribut_type_date_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  private Collection<IntentionExecutable> myCachedExecutable;

  public intention_set_Atribut_type_date_Intention() {
    super(Kind.ERROR, false, new SNodePointer("r:90274395-b22a-4026-877b-f66a97996602(ClassDiagramDSLMilosProrocic.intentions)", "1517646760598764239"));
  }

  @Override
  public String getPresentation() {
    return "intention_set_Atribut_type_date";
  }
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public String getDescription(final SNode node, final EditorContext editorContext) {
      return "Postavi tip date";
    }

    @Override
    public void execute(final SNode node, final EditorContext editorContext) {
      SPropertyOperations.assign(node, PROPS.tipAtributa$Len0, "date");
    }
    ...
    private boolean isApplicableToNode(final SNode node, final EditorContext editorContext) {
      ...
      return SPropertyOperations.getString(node, PROPS.tipAtributa$Len0) == null || ("date".contains(SPropertyOperations.getString(node, PROPS.tipAtributa$Len0)) && !(SPropertyOperations.getString(node, PROPS.tipAtributa$Len0).equals("date")));
    }


    @Override
    public IntentionDescriptor getDescriptor() {
      return intention_set_Atribut_type_date_Intention.this;
    }
